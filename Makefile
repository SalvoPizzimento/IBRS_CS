...
upload-releases:
	scp $(RELEASES) diraimondo@www.dmi.unict.it:crypto/1819/examples-*

clean:
	$(RM) $(EPROGS) $(OBJS) $(POBJS) $(DEPS_FILE) $(PLOTS_SVG) $(OTHER_FILES_TO_CLEAN) p.txt ppub.txt keys.txt param.txt sign.txt
